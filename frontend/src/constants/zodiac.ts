...
export const ZODIACS: Zodiac[] = [
  { key: 'capricorn',   nameEn: 'Capricorn',   nameRu: 'Козерог',   glyph: '♑', start: '01-20', end: '02-16' },
  { key: 'aquarius',    nameEn: 'Aquarius',    nameRu: 'Водолей',   glyph: '♒', start: '02-17', end: '03-11' },
  { key: 'pisces',      nameEn: 'Pisces',      nameRu: 'Рыбы',      glyph: '♓', start: '03-12', end: '04-18' },
  { key: 'aries',       nameEn: 'Aries',       nameRu: 'Овен',      glyph: '♈', start: '04-19', end: '05-14' },
  { key: 'taurus',      nameEn: 'Taurus',      nameRu: 'Телец',     glyph: '♉', start: '05-15', end: '06-21' },
  { key: 'gemini',      nameEn: 'Gemini',      nameRu: 'Близнецы',  glyph: '♊', start: '06-22', end: '07-20' },
  { key: 'cancer',      nameEn: 'Cancer',      nameRu: 'Рак',       glyph: '♋', start: '07-21', end: '08-10' },
  { key: 'leo',         nameEn: 'Leo',         nameRu: 'Лев',       glyph: '♌', start: '08-11', end: '09-16' },
  { key: 'virgo',       nameEn: 'Virgo',       nameRu: 'Дева',      glyph: '♍', start: '09-17', end: '10-31' },
  { key: 'libra',       nameEn: 'Libra',       nameRu: 'Весы',      glyph: '♎', start: '11-01', end: '11-23' },
  { key: 'scorpio',     nameEn: 'Scorpio',     nameRu: 'Скорпион',  glyph: '♏', start: '11-24', end: '11-30' },
  { key: 'ophiuchus',   nameEn: 'Ophiuchus',   nameRu: 'Змееносец', glyph: '⛎', start: '12-01', end: '12-18' },
  { key: 'sagittarius', nameEn: 'Sagittarius', nameRu: 'Стрелец',   glyph: '♐', start: '12-19', end: '01-19' },
]
